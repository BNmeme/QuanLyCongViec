...
fun CreateGroupScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Create Group", color = MaterialTheme.colorScheme.onPrimary) },
        ...
        Box(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    modifier = Modifier.fillMaxWidth(),
                    shape = RoundedCornerShape(12.dp),
                    isError = uiState.groupDescriptionError != null,
                    keyboardOptions = KeyboardOptions(
                ...
                if (uiState.groupDescriptionError != null) {
                    Text(
                        text = uiState.groupDescriptionError!!,
                        color = MaterialTheme.colorScheme.error,
                        style = MaterialTheme.typography.bodySmall,
                        modifier = Modifier
                            .fillMaxWidth()
