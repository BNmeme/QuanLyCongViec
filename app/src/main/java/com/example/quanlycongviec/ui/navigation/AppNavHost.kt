...
fun AppNavHost(navController: NavHostController) {
    NavHost(
        ...
        composable("${Screen.PersonalTaskDetail.route}/{taskId}") { backStackEntry ->
        ...
        composable("${Screen.GroupTaskDetail.route}/{taskId}") { backStackEntry ->
            val taskId = backStackEntry.arguments?.getString("taskId") ?: ""
        ...
        composable("${Screen.EditGroupTask.route}/{taskId}") { backStackEntry ->
            val taskId = backStackEntry.arguments?.getString("taskId") ?: ""
            EditGroupTaskScreen(
                taskId = taskId,
                onNavigateBack = { navController.navigateUp() }
